...
@onready var button_new: Button = $CanvasLayer/ButtonNew
@onready var button_continue: Button = $CanvasLayer/ButtonContinue
...
func _ready() -> void:
	...
	LevalManager.level_load_started.connect( exit_title_screen )
...
func start_game() -> void:
	...
	LevalManager.load_new_level( START_LEVEL, "", Vector2.ZERO )
	pass
